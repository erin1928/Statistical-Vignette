...
The Anderson Darling test is a form of the Goodness of Fit test used to determine if a sample of data comes from a specific kind of distribution. It is commonly used to determine if the sample of data came from a normal distribution. It is a modification of the Kolmogorov-Smirnov test that gives more weight to the tails. The more weight on the tails, the more accurate the results. 
 ...
 Source: https://www.itl.nist.gov/div898/handbook/eda/section3/eda35e.htm
...
Source: https://www.statology.org/anderson-darling-test-r/ and https://variation.com/wp-content/distribution_analyzer_help/hs140.htm

## Using the Anderson-Darling Test with Data Known as "chickwts" 

<font size="+2"> Description of the Data Set: Newly hatched chicks were randomly allocated into six groups, and each group was given a different feed supplement. Their weights in grams after six weeks are given along with feed types. 
<br>

Source:https://www.rdocumentation.org/packages/datasets/versions/3.6.2/topics/chickwts</font>
<br>
...
Source: https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=d973dfd21d5c3ee5b5860191ee0de9635111dda1
...
Source: https://search.r-project.org/CRAN/refmans/nortest/html/ad.test.html
<br> 
