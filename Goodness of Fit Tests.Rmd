...
The Anderson Darling test is a form of the Goodness of Fit test used to determine if a sample of data comes from a specific kind of distribution. It is commonly used to determine if the sample of data came from a normal distribution. It is a modification of the Kolmogorov-Smirnov test that gives more weight to the tails. The more weight on the tails, the more accurate the results. 
  ...
  1. H0 is the data that follows a specific distribution
  2. HA is the data that does not follow the specific distribution 
...
<font size="+2"> Description of the Data Set: Newly hatched chicks were randomly allocated into six groups, and each group was given a different feed supplement. Their weights in grams after six weeks are given along with feed types. (https://www.rdocumentation.org/packages/datasets/versions/3.6.2/topics/chickwts)</font>
<br>
...
A <- -n - mean(h)
A # The alpha value is computed (In this case, the aplha value only matters in determining the p value.)
```
