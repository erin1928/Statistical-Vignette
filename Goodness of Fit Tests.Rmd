...
We can use the <b>Kolmorgorov-Smirnov Test</b> as a way to test if our hypothesized results are correct (one-sample) or if two data sets come from the same distribution (two-sample). By using this statistical method, we are aiming to prove that the two data sets we are working with do not come from the same distribution.
