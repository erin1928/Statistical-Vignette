...
## Anderson Darling Test Statistic Formula: 

The formula below gives you the test statistic for your specified distribution, which will be modified to find the p-value. The test statistic needs to be modified for small data sets. Once we have the p-value, we can determine whether we can reject the null hypothesis or fail to reject the null.
