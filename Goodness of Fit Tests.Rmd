...
[2] Be able identify which test is most appropriate for your dataset

[K-S] Understand what a Kolmogorov-Smirnov Test is and how to interpret the results. 

[K-S] Learn what conditions are ideal for a K-S
...
<font size="+2"> Description of the Data Set: Newly hatched chicks were randomly allocated into six groups, and each group was given a different feed supplement. Their weights in grams after six weeks are given along with feed types. </font>
<br>
